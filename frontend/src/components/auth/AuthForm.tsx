  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === 'signin') {
        ...
        await signUp(formData.email, formData.password, formData.displayName, formData.role as 'client' | 'consultant');
      }
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 relative">
        <Link
          href="/"
          className="absolute -top-12 left-0 flex items-center text-primary-600 hover:text-primary-700 transition-colors"
        >
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            ...
            <div>
              ...
              <input
                ...
                } focus:outline-none focus:ring-primary-500 focus:border-primary-500 focus:z-10 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white`}
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <button
                ...
                disabled={loading}
                className="w-full flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-700"
              >
